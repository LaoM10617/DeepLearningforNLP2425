...
"""get_ipython().system('pip install datasets==3.0.1')
get_ipython().system('pip install datasets==3.0.1')
get_ipython().system('pip install spacy==3.6.1')
get_ipython().system('pip install torch==2.0.1    # just to be sure we are all working with the same version')
...
#print(f"Index of '<UNK>': {vocab['<UNK>']}")
#print(f"Index of unknown token 'some_unknown_token': {vocab['some_unknown_token']}")
...
#print(f"Sample train indices: {train_idx[0]}")
#print(f"Sample dev indices: {dev_idx[0]}")
#print(f"Sample test indices: {test_idx[0]}")
...
print(f"Sample train input and label: {train_set[0]}")
